...
static void findColorPaletteIterativeDXT1RGB(rgb565_t *in_out_bestC0, rgb565_t *in_out_bestC1, uint32_t *in_out_bestError, const rgb8_t in_BLOCK_RGB[4][4], const uint32_t in_MAX_RANGE,
                                             const bool in_MORE_AGGRESSIVE) {
...
// iterative method (shift one end or pinch/expand both ends)
static void findColorPaletteIterativeDXT1RGBAOpaque(rgb565_t *in_out_bestC0, rgb565_t *in_out_bestC1, uint32_t *in_out_bestError, const rgba8_t in_BLOCK_RGBA[4][4], const uint32_t in_MAX_RANGE,
                                                    const bool in_MORE_AGGRESSIVE) {
    uint32_t bestError = *in_out_bestError;
    rgb565_t bestC0 = *in_out_bestC0;
    rgb565_t bestC1 = *in_out_bestC1;
...
// iterative method (shift one end or pinch/expand both ends)
static void findColorPaletteIterativeDXT1RGBATransparent(rgb565_t *in_out_bestC0, rgb565_t *in_out_bestC1, uint32_t *in_out_bestError, const rgba8_t in_BLOCK_RGBA[4][4], const uint32_t in_MAX_RANGE,
                                                         const bool in_MORE_AGGRESSIVE) {
    uint32_t bestError = *in_out_bestError;
    rgb565_t bestC0 = *in_out_bestC0;
    rgb565_t bestC1 = *in_out_bestC1;
...
// iterative method (shift one end or pinch/expand both ends)
static void findColorPaletteIterativeDXT3(rgb565_t *in_out_bestC0, rgb565_t *in_out_bestC1, uint32_t *in_out_bestError, const rgba8_t in_BLOCK_RGBA[4][4], const uint32_t in_MAX_RANGE,
                                          const bool in_MORE_AGGRESSIVE) {
    uint32_t bestError = *in_out_bestError;
    rgb565_t bestC0 = *in_out_bestC0;
    rgb565_t bestC1 = *in_out_bestC1;
