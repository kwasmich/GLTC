...
void findAlphaPaletteIterativeDXT5(uint8_t *in_out_bestA0, uint8_t *in_out_bestA1, uint32_t *in_out_bestError, const rgba8_t in_BLOCK_RGBA[4][4], const uint32_t in_MAX_RANGE,
